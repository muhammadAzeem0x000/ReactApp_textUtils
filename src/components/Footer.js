...
export default function Footer() {
  return (
    <footer className="container pb-4 pt-2 text-center" style={{ color: 'var(--text-muted)', fontSize: '0.9rem' }}>
      <hr style={{ borderColor: 'var(--border-color)', opacity: 0.5, marginBottom: '1.5rem' }} />
      <div className="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
        <div>
          Built with ❤️ by <strong style={{ color: 'var(--text-primary)' }}>Muhammad Azeem</strong>
        </div>
        <div className="d-flex align-items-center gap-3">
          ...
          <a 
            href="https://www.linkedin.com/in/muhammad-azeem012" 
            target="_blank" 
            rel="noopener noreferrer" 
            style={{ color: 'var(--text-muted)', transition: 'color 0.2s ease' }}
